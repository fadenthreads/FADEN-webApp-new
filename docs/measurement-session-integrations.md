...
No live provider call, room, participant token, calendar event, email or SMS is created in this phase. Before activation, add protected provisioning/join routes, idempotent persistence, cancellation revocation, audit events, rate limits, Daily webhook verification, accessibility testing of the call UI, and end-to-end tests with test accounts. Confirm the boutique venue before travel; maps/autocomplete are aids, not proof that a location is safe or open.
